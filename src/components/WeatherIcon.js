...
const WeatherIcon = (props) => {
  ...
  if (
    ...
    props.description === "light intensity drizzle rain" ||
    props.description === "shower rain"
  ) {
    icon = "weather-rain";
  } else if (
    props.description === "heavy intensity rain" ||
    props.description === "heavy intensity shower rain"
  ) {
